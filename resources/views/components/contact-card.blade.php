...
<form method="POST" action="contact"
    {{$attributes->merge(['class' => 'text-center bg-gray-50 rounded-xl shadow md:w-11/12 w-100 mx-auto p-3'])}}>
    @CSRF
    <div class="flex flex-col mx-auto w-100 sm:w-96 md:w-100 lg:w-1/2">
        ...
        <div class="flex flex-col sm:flex-row">
            <div class="flex flex-col w-full mr-0 sm:mr-1 mb-1">
                ...
                <x-input id="name" name="name" class="{{ $errors->has('name') ? 'border-red-400' : '' }} px-1 w-100"
            ...
            <div class="flex flex-col w-full ml-0 sm:ml-1 mb-1">
                ...
                <x-input id="email" name="email" class="{{ $errors->has('email') ? 'border-red-400' : '' }} px-1 w-100"
    ...
    <div
        class="modal fixed w-100 h-full top-0 left-0 md:pl-72 mt-12 md:mt-0 flex opacity-0 pointer-events-none transition duration-1000">
        ...
        <div class="modal-container absolute h-full w-full md:pr-72 flex flex-col z-50">
            ...
            <div class="w-full flex">
                <div class="flex-grow"></div>
                <div class="modal-content bg-gray-100 p-6 text-left rounded-xl shadow-xl max-w-sm md:max-w-md">
                    <div class="flex flex-col justify-between items-center">
                        <div class="flex w-100">
                            <p class="text-2xl w-100 font-bold text-gray-800 pb-2 text-center">Hold Up!</p>
                        </div>
                        <div class="flex w-100">
                            <div class="w-100 text-gray-800 dark:text-white -mt-9 flex">
                                <div class="flex-grow"></div>
                                <svg class="fill-current modal-close cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                                    <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z"></path>
                                </svg>
                            </div>
                        </div>
                        <div class="text-center">
                            <p>Due to spam on this form, I have to ask people to complete a test to prove they're human.
                            </p>
